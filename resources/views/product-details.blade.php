            ...
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <div class="breadcrumb-title breadcrumb-title-responsive">
                        <h2 data-aos="fade-up" data-aos-delay="200">Nike long sleeve Blue mini dress</h2>
                    </div>
        ...
        <div class="product-details-area section-padding-lr-2 pb-115">
            <div class="container-fluid">
                <div class="back-to-shop" data-aos="fade-up" data-aos-delay="200">
                    <a href="shop"><img class="injectable" src="images/icon-img/arrow-left-6.svg" alt=""> Back to Shop</a>
                </div>
                <div class="row">
                    <div class="col-lg-7">
                        <div class="product-details-tab" data-aos="fade-up" data-aos-delay="300">
                            <div class="pro-dec-big-img-slider">
                                <div class="easyzoom-style">
                                    <div class="easyzoom easyzoom--overlay">
                                        <a href="images/product-details/b-large-1.png">
                                            <img src="images/product-details/large-1.png" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="easyzoom-style">
                                    <div class="easyzoom easyzoom--overlay">
                                        <a href="images/product-details/b-large-2.png">
                                            <img src="images/product-details/large-2.png" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="easyzoom-style">
                                    <div class="easyzoom easyzoom--overlay">
                                        <a href="images/product-details/b-large-3.png">
                                            <img src="images/product-details/large-3.png" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="easyzoom-style">
                                    <div class="easyzoom easyzoom--overlay">
                                        <a href="images/product-details/b-large-4.png">
                                            <img src="images/product-details/large-4.png" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="easyzoom-style">
                            ...
                            <div class="product-dec-slider-small product-dec-small-style1">
                                <div class="product-dec-small active">
                                    <img src="images/product-details/small-1.png" alt="">
                                </div>
                                <div class="product-dec-small">
                                    <img src="images/product-details/small-2.png" alt="">
                                </div>
                                <div class="product-dec-small">
                                    <img src="images/product-details/small-3.png" alt="">
                                </div>
                                <div class="product-dec-small">
                                    <img src="images/product-details/small-4.png" alt="">
                                </div>
                                <div class="product-dec-small">
                                    <img src="images/product-details/small-2.png" alt="">
                                </div>
                        ...
                        <div class="product-details-content product-details-mrg-left">
                            <div class="product-rating-stock-review" data-aos="fade-up" data-aos-delay="200">
                                <div class="product-rating">
                                    <a class="yellow" href="#"><img class="injectable" src="images/icon-img/star-gray-full.svg" alt=""></a>
                                    <a class="yellow" href="#"><img class="injectable" src="images/icon-img/star-gray-full.svg" alt=""></a>
                                    <a class="yellow" href="#"><img class="injectable" src="images/icon-img/star-gray-full.svg" alt=""></a>
                                    <a class="yellow-half" href="#"><img class="injectable" src="images/icon-img/star-gray-half.svg" alt=""></a>
                                    <a class="gray" href="#"><img class="injectable" src="images/icon-img/star-gray-full.svg" alt=""></a>
                                </div>
                                <div class="product-review">
                                    <span>5  Reviews</span>
                                </div>
                                <div class="product-stock">
                                    <a href="#"><img src="images/icon-img/check-circle.svg" alt=""></a>
                                    <span>In Stock</span>
                                </div>
                            </div>
                            <h2 data-aos="fade-up" data-aos-delay="300">PLUSH BALLOON SLEEVE DRESS</h2>
                            <div class="product-details-price" data-aos="fade-up" data-aos-delay="400">
                                <span>$49.99</span>
                            </div>
                            <p data-aos="fade-up" data-aos-delay="500">In elit risus, volutpat sed vestibulum sit amet, bibendum in lorem. Etiam aliquet convallis nibh at tempus. Proin gravida tincidunt egestas. Curabitur porta nibh ac enim semper, vitae pretium ante sollicitudin.</p>
                            ...
                            <div class="product-details-wishlist-compare" data-aos="fade-up" data-aos-delay="300">
                                <div class="product-details-wishlist">
                                    <a href="#">
                                        <img class="injectable" src="images/icon-img/heart-2.svg" alt="">
                                        Add to wishlist
                                    </a>
                                </div>
                                <div class="product-details-compare">
                                    <a href="#">
                                        <img class="injectable" src="images/icon-img/compare.svg" alt="">
                                        ADD TO COMPARE
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="product-details-social" data-aos="fade-up" data-aos-delay="500">
                                <a class="facebook" href="#"><img class="injectable" src="images/icon-img/facebook.svg" alt=""></a>
                                <a class="twitter" href="#"><img class="injectable" src="images/icon-img/twitter.svg" alt=""></a>
                                <a class="pinterest" href="#"><img class="injectable" src="images/icon-img/pinterest.svg" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-5">
                                        <div class="pro-description-banner" data-aos="fade-up" data-aos-delay="300">
                                            <img src="images/product-details/pro-details-banner.png" alt="">
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                            ...
                            <div class="review-wrapper">
                                ...
                                <div class="single-review">
                                    <div class="review-img">
                                        <img src="images/product-details/review-1.jpg" alt="">
                                    </div>
                                    <div class="review-content">
                                        <div class="review-rating">
                                            ...
                                            <a class="yellow" href="#"><img class="injectable" src="images/icon-img/star-gray-full.svg" alt=""></a>
                                            <a class="yellow" href="#"><img class="injectable" src="images/icon-img/star-gray-full.svg" alt=""></a>
                                            <a class="yellow" href="#"><img class="injectable" src="images/icon-img/star-gray-half.svg" alt=""></a>
                                            <a class="gray" href="#"><img class="injectable" src="images/icon-img/star-gray-full.svg" alt=""></a>
                                        </div>
                        ...
                        <div id="des-details4" class="tab-pane">
                            <div class="vendor-info-content">
                                ...
                                <ul>
                                    ...
                                    <li class="rating"><span><img class="injectable" src="images/icon-img/star-gray-full.svg" alt=""><img class="injectable" src="images/icon-img/star-gray-full.svg" alt=""><img class="injectable" src="images/icon-img/star-gray-full.svg" alt=""><img class="injectable" src="images/icon-img/star-gray-full.svg" alt=""><img class="injectable" src="images/icon-img/star-gray-full.svg" alt=""></span>5.00 rating from 1 review</li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="related-product-active">
                        ...
                        <div class="product-wrap">
                            <div class="product-img img-zoom mb-4">
                                <a href="product-details">
                                    <img class="default-img" src="images/product/product-5.png" alt="">
                                </a>
                                <div class="product-action-wrap">
                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><img class="injectable" src="images/icon-img/eye.svg" alt=""></button>
                                    <button title="Add To Cart"><img class="injectable" src="images/icon-img/bag-2.svg" alt=""></button>
                                    <button title="Wishlist"><img class="injectable" src="images/icon-img/heart.svg" alt=""></button>
                                </div>
                            </div>
                            <div class="product-content text-center">
                                <h3><a href="product-details">VERTICAL QUILTED OVERSHIRT</a></h3>
                    ...
                    <div class="product-plr-1" data-aos="fade-up" data-aos-delay="300">
                        <div class="product-wrap">
                            <div class="product-img img-zoom mb-4">
                                <a href="product-details">
                                    <img class="default-img" src="images/product/product-6.png" alt="">
                                </a>
                                <div class="product-action-wrap">
                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><img class="injectable" src="images/icon-img/eye.svg" alt=""></button>
                                    <button title="Add To Cart"><img class="injectable" src="images/icon-img/bag-2.svg" alt=""></button>
                            ...
                            <div class="product-content text-center">
                                <h3><a href="product-details">KNIT TECHNICAL FABRIC SNEAKERS</a></h3>
                                <div class="product-price">
                                    <span>$39.99</span>
                                </div>
                            </div>
                    ...
                    <div class="product-plr-1" data-aos="fade-up" data-aos-delay="400">
                        <div class="product-wrap">
                            <div class="product-img img-zoom mb-4">
                                <a href="product-details">
                                    <img class="default-img" src="images/product/product-7.png" alt="">
                                </a>
                                <div class="product-action-wrap">
                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><img class="injectable" src="images/icon-img/eye.svg" alt=""></button>
                                    <button title="Add To Cart"><img class="injectable" src="images/icon-img/bag-2.svg" alt=""></button>
                            ...
                            <div class="product-content text-center">
                                <h3><a href="product-details">BOILED WOOL SWEATER</a></h3>
                                <div class="product-price">
                                    <span>$39.99</span>
                                </div>
                            </div>
                    ...
                    <div class="product-plr-1" data-aos="fade-up" data-aos-delay="500">
                        <div class="product-wrap">
                            <div class="product-img img-zoom mb-4">
                                <a href="product-details">
                                    <img class="default-img" src="images/product/product-8.png" alt="">
                                </a>
                                <div class="product-action-wrap">
                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><img class="injectable" src="images/icon-img/eye.svg" alt=""></button>
                                    <button title="Add To Cart"><img class="injectable" src="images/icon-img/bag-2.svg" alt=""></button>
                            ...
                            <div class="product-content text-center">
                                <h3><a href="product-details">PLUSH BALLOON SLEEVE DRESS</a></h3>
                                <div class="product-price">
                                    <span>$39.99</span>
                                </div>
                            </div>
                    ...
                    <div class="product-plr-1">
                        <div class="product-wrap">
                            <div class="product-img img-zoom mb-4">
                                <a href="product-details">
                                    <img class="default-img" src="images/product/product-4.png" alt="">
                                </a>
                                <div class="product-action-wrap">
                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><img class="injectable" src="images/icon-img/eye.svg" alt=""></button>
                                    <button title="Add To Cart"><img class="injectable" src="images/icon-img/bag-2.svg" alt=""></button>
                            ...
                            <div class="product-content text-center">
                                <h3><a href="product-details">OVERSIZED HOODED SWEATSHIRT</a></h3>
                                <div class="product-price">
                                    <span>$39.99</span>
                                </div>
                            </div>
                        ...
                        <div class="row no-gutters">
                            <div class="col-lg-5 col-md-12 col-12">
                                <div class="quickview-img">
                                    <a href="product-details"><img src="images/product-details/large-1.png" alt=""></a>
                                </div>
