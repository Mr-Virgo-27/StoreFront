                ...
                <div class="cart-content">
                    ...
                    <ul>
                        <li class="single-product-cart">
                            <div class="cart-img">
                                <a href="product-details"><img src="images/product/product-1.png"
                                        alt=""></a>
                            </div>
                        ...
                        <li class="single-product-cart">
                            <div class="cart-img">
                                <a href="product-details"><img src="images/product/product-2.png"
                                        alt=""></a>
                            </div>
                            <div class="cart-title">
            ...
            <div class="slider-active-1 nav-style-1">
                <div
                    ...
                    <div class="slider-content slider-animated-1">
                        ...
                        <div class="btn-style">
                            <a class="btn btn-outline-primary slider-btn animated" href="product-details">Shop
                                now</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="trend-product-wrap">
                <div class="container-fluid p-0">
                    <div class="product-img-position">
                        <img src="images/product/trend.png" alt="">
                    </div>
                    <div class="row gx-0">
                        <div class="offset-lg-6 col-lg-6">
                            <div class="trend-product-content">
                                ...
                                <div class="btn-style" data-aos="fade-up" data-aos-delay="400">
                                    <a class="btn btn-outline-primary animated" href="product-details">Shop now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="product-action-wrap">
                                            <button title="Quick View" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal"><img class="injectable"
                                                    src="images/icon-img/eye.svg" alt=""></button>
                                            <button title="Add To Cart"><img class="injectable"
                                                    src="images/icon-img/bag-2.svg" alt=""></button>
                                            <button title="Wishlist"><img class="injectable"
                                                    src="images/icon-img/heart.svg" alt=""></button>
                                        </div>
                                    </div>
                            ...
                            <div class="product-slider-active nav-style-2" data-aos="fade-up" data-aos-delay="200">
                                <div class="product-plr-1">
                                    <div class="product-wrap">
                                        <div class="product-img img-zoom mb-5">
                                            <a href="product-details">
                                                <img class="default-img" src="images/product/product-9.png"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-content-2">
                                            <h3><a href="product-details">COAT 2021</a></h3>
                                            <span>OFF 30%</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-plr-1">
                                    <div class="product-wrap">
                                        <div class="product-img img-zoom mb-5">
                                            <a href="product-details">
                                                <img class="default-img" src="images/product/product-10.png"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-content-2">
                                            <h3><a href="product-details">MEN SUITS</a></h3>
                                            <span>OFF 30%</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="mc_embed_signup" class="subscribe-form" data-aos="fade-up" data-aos-delay="400">
                        <form id="mc-embedded-subscribe-form" class="validate subscribe-form-style-2" novalidate=""
                            ...
                            <div id="mc_embed_signup_scroll" class="mc-form">
                                <input class="email" type="email" required="" placeholder="Email addressâ€¦" name="EMAIL"
                                    value="">
                            ...
                            <div class="row mb-n6">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-6">
                                    <div class="instagram-img" data-aos="fade-up" data-aos-delay="200">
                                        <a href="#"><img src="images/instagram/instagram-1.png" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-6">
                                    <div class="instagram-img" data-aos="fade-up" data-aos-delay="300">
                                        <a href="#"><img src="images/instagram/instagram-2.png" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-6">
                                    <div class="instagram-img" data-aos="fade-up" data-aos-delay="200">
                                        <a href="#"><img src="images/instagram/instagram-3.png" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-6">
                                    <div class="instagram-img" data-aos="fade-up" data-aos-delay="300">
                                        <a href="#"><img src="images/instagram/instagram-4.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row mb-n6">
                    <div class="col-lg-6 mb-6">
                        <div class="banner-wrap img-zoom" data-aos="fade-up" data-aos-delay="200">
                            <a href="product-details"><img src="images/banner/banner-1.png" alt=""></a>
                    ...
                    <div class="col-lg-6 mb-6">
                        <div class="banner-wrap img-zoom" data-aos="fade-up" data-aos-delay="300">
                            <a href="product-details"><img src="images/banner/banner-2.png" alt=""></a>
                            <div class="banner-content-2">
                                <h3>Great Holiday</h3>
                                <h2>Upto 50%</h2>
                                <div class="btn-style">
                                    <a class="btn btn-outline-primary animated btn-padding-2"
                                        href="product-details">Shop now</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="footer-area section-padding-lr-2 bg-gray">
            <div class="container-fluid">
                        ...
                        <div class="col-19-5 mb-6">
                            <div class="footer-widget footer-list">
                                ...
                                <div class="social-icon">
                                    <a href="#"><img class="injectable" src="images/icon-img/facebook.svg"
                                            alt=""></a>
                                    <a href="#"><img class="injectable" src="images/icon-img/twitter.svg"
                                            alt=""></a>
                                    <a href="#"><img class="injectable" src="images/icon-img/instagram.svg"
                                            alt=""></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="footer-bottom copyright border-top-1 text-center">
                    <p>Copyright Â©2021 All rights reserved | Made with <img class="injectable"
                            src="images/icon-img/love.svg" alt=""> by <a
                        ...
                        <div class="row no-gutters">
                            <div class="col-lg-5 col-md-12 col-12">
                                <div class="quickview-img">
                                    <a href="product-details"><img src="images/product-details/large-1.png"
                                            alt=""></a>
                                </div>
