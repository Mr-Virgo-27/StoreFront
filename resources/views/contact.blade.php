                    ...
                    <div class="row">
                            ...
                            <div class="contact-form-wrap">
                                ...
                                <form class="contact-form-style padding-20-row-col" id="contact-form" action="https://htmlmail.hasthemes.com/tasnim/lauriel-two-mail.php" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-12">
                                            <input name="contact_subject" type="text" placeholder="Inquiry Type*">
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="contact-info-area">
                                <ul>
                                    <li><img class="injectable icon-width-1" src="images/icon-img/phone-call.svg" alt=""> <span> +55 858 5858 68</span></li>
                                    <li><img class="injectable icon-width-2" src="images/icon-img/email.svg" alt=""> <span>support@hastech.com</span></li>
                                    <li><a href="#"><img class="injectable icon-width-3" src="images/icon-img/comment.svg" alt=""> <span>Live chat with us</span></a></li>
                                    <li><img class="injectable icon-width-4" src="images/icon-img/pin.svg" alt=""> <span>PO Box 16122 Collins Street West <br>Victoria 8007 Australia</span></li>
                                </ul>
                                <div class="contact-info-social">
                                    <a href="#"><img class="injectable" src="images/icon-img/facebook2.svg" alt=""></a>
                                    <a href="#"><img class="injectable" src="images/icon-img/twitter2.svg" alt=""></a>
                                    <a href="#"><img class="injectable" src="images/icon-img/pinterest.svg" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
