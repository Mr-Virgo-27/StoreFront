                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-75">
                                        <div class="product-wrap" data-aos="fade-up" data-aos-delay="300">
                                            <div class="product-img img-zoom mb-4">
                                                <a href="product-details">
                                                    <img class="default-img" src="images/product/product-15.png" alt="">
                                                </a>
                                                <div class="product-action-wrap">
                                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><img class="injectable" src="images/icon-img/eye.svg" alt=""></button>
                                                    <button title="Add To Cart"><img class="injectable" src="images/icon-img/bag-2.svg" alt=""></button>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-75">
                                        <div class="product-wrap" data-aos="fade-up" data-aos-delay="400">
                                            <div class="product-img img-zoom mb-4">
                                                <a href="product-details">
                                                    <img class="default-img" src="images/product/product-16.png" alt="">
                                                </a>
                                                <div class="product-action-wrap">
                                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><img class="injectable" src="images/icon-img/eye.svg" alt=""></button>
                                                    <button title="Add To Cart"><img class="injectable" src="images/icon-img/bag-2.svg" alt=""></button>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-75">
                                        <div class="product-wrap" data-aos="fade-up" data-aos-delay="300">
                                            <div class="product-img img-zoom mb-4">
                                                <a href="product-details">
                                                    <img class="default-img" src="images/product/product-17.png" alt="">
                                                </a>
                                                <div class="product-action-wrap">
                                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><img class="injectable" src="images/icon-img/eye.svg" alt=""></button>
                                                    <button title="Add To Cart"><img class="injectable" src="images/icon-img/bag-2.svg" alt=""></button>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-75">
                                        <div class="product-wrap" data-aos="fade-up" data-aos-delay="400">
                                            <div class="product-img img-zoom mb-4">
                                                <a href="product-details">
                                                    <img class="default-img" src="images/product/product-18.png" alt="">
                                                </a>
                                                <div class="product-action-wrap">
                                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><img class="injectable" src="images/icon-img/eye.svg" alt=""></button>
                                                    <button title="Add To Cart"><img class="injectable" src="images/icon-img/bag-2.svg" alt=""></button>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-75">
                                        <div class="product-wrap" data-aos="fade-up" data-aos-delay="200">
                                            <div class="product-img img-zoom mb-4">
                                                <a href="product-details">
                                                    <img class="default-img" src="images/product/product-19.png" alt="">
                                                </a>
                                                <div class="product-action-wrap">
                                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><img class="injectable" src="images/icon-img/eye.svg" alt=""></button>
                                                    <button title="Add To Cart"><img class="injectable" src="images/icon-img/bag-2.svg" alt=""></button>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-75">
                                        <div class="product-wrap" data-aos="fade-up" data-aos-delay="400">
                                            <div class="product-img img-zoom mb-4">
                                                <a href="product-details">
                                                    <img class="default-img" src="images/product/product-20.png" alt="">
                                                </a>
                                                <div class="product-action-wrap">
                                                    <button title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal"><img class="injectable" src="images/icon-img/eye.svg" alt=""></button>
                                                    <button title="Add To Cart"><img class="injectable" src="images/icon-img/bag-2.svg" alt=""></button>
                        ...
                        <div class="sidebar-wrapper sidebar-wrapper-mr">
                            <div class="sidebar-widget mb-80" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="shop-category">
                                    <ul>
                                        ...
                                        <li><a href="shop">Motor Parts</a></li>
                                        <li><a href="shop">Leather Handmade</a></li>
                                        <li><a href="shop">Beauty</a></li>
                                        <li><a href="shop">Electronic</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-2 col-6 col-sm-4">
                                            <div class="instagram-img mb-4">
                                                <a href="#"><img src="images/instagram/instagram-9.png" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-2 col-6 col-sm-4">
                                            <div class="instagram-img mb-4">
                                                <a href="#"><img src="images/instagram/instagram-10.png" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-2 col-6 col-sm-4">
                                            <div class="instagram-img mb-4">
                                                <a href="#"><img src="images/instagram/instagram-11.png" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-2 col-6 col-sm-4">
                                            <div class="instagram-img mb-4">
                                                <a href="#"><img src="images/instagram/instagram-12.png" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-2 col-6 col-sm-4">
                                            <div class="instagram-img mb-4">
                                                <a href="#"><img src="images/instagram/instagram-13.png" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-2 col-6 col-sm-4">
                                            <div class="instagram-img mb-4">
                                                <a href="#"><img src="images/instagram/instagram-14.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="sidebar-widget" data-aos="fade-up" data-aos-delay="200">
                                <div class="banner-wrap img-zoom">
                                    <a href="product-details"><img src="images/banner/banner-3.png" alt=""></a>
                                    <div class="banner-content-3">
                                        <h4>HOLIDAY SALE</h4>
                                        <h2>off 30%</h2>
                                        <div class="banner-btn-style">
                                            <a class="btn" href="product-details">Shop now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
